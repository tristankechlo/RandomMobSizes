...
public enum SamplerTypes implements StringIdentifiable {
    ...
    public static final Codec<SamplerTypes> CODEC;
    ...
    static {
        CODEC = StringIdentifiable.createCodec(SamplerTypes::values);
    }
