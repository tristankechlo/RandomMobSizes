...
public final class ConfigManager {
    ...
    public static void loadAndVerifyConfig() {
        ...
        if (configFile.exists()) {
            ...
            RandomMobSizesMod.LOGGER.info("Saved the checked/corrected config: '{}'", FILE_NAME);
        } else {
            ConfigManager.writeConfigToFile(configFile);
            RandomMobSizesMod.LOGGER.warn("No config '{}' was found, created a new one.", FILE_NAME);
        }
    }
    ...
    private static void writeConfigToFile(File file) {
        ...
        try {
            ...
            RandomMobSizesMod.LOGGER.error("There was an error writing the config to file: '{}'", FILE_NAME);
            e.printStackTrace();
        }
    }
    ...
    private static void loadConfigFromFile(File file) {
        ...
        if (json != null) {
            ...
            RandomMobSizesMod.LOGGER.info("Config '{}' was successfully loaded.", FILE_NAME);
        } else {
            RandomMobSizesMod.LOGGER.error("Error loading config '{}', config hasn't been loaded.", FILE_NAME);
        }
    }
